  ...
  try {
    ...
    await sequelize.query(
      `INSERT INTO "Classrooms" (class_id, class_level, teacher_id, homeroom_teacher_id, academic_year, subject, created_at)
       VALUES 
       (1, 'Grade 1-A', 3, 3, '2026', NULL, NOW()),
       (2, 'Grade 2-B', 4, 4, '2026', NULL, NOW()),
    ...
    const subjectMappings = [
      ...
      { classLevel: 'Grade 1-A', teacherId: 16, homeroomTeacherId: 3, academicYear: '2026', subject: 'Science' },
      { classLevel: 'Grade 2-B', teacherId: 16, homeroomTeacherId: 4, academicYear: '2026', subject: 'Science' },

      // 6. Ms. Karen White (ID 17) - Grade 2-B & 3-B - English
      { classLevel: 'Grade 2-B', teacherId: 17, homeroomTeacherId: 4, academicYear: '2026', subject: 'English' },
