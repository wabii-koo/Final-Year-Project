...
const ROLE_HINTS: Record<
  Role,
  { label: string; email: string; password: string; badge?: string }[]
> = {
  Parent: [],
  Teacher: [
    {
      label: "Mr. Alex Brown (Subject Teacher)",
      email: "teacher@school.com",
      password: "teacher789",
    },
    {
      label: "Ms. Sarah Smith (English / Soc. Studies)",
      email: "sarah.smith@school.com",
      password: "Smith1A@2026",
      badge: "Grade 1-A & 2-B",
    },
    {
      label: "Mr. James Johnson (Math / Soc. Studies)",
      email: "james.johnson@school.com",
      password: "Johnson2B@2026",
      badge: "Grade 2-B & 3-B",
    },
    {
      label: "Mrs. Emily Davis (Science / Soc. Studies)",
      email: "emily.davis@school.com",
      password: "Davis3B@2026",
      badge: "Grade 1-A & 3-B",
    },
    {
      label: "Mr. Robert Miller (Mathematics)",
      email: "robert.miller@school.com",
      password: "MillerMath@2026",
      badge: "Grade 1-A & 3-B",
    },
    {
      label: "Dr. Lisa Green (Science)",
      email: "lisa.green@school.com",
      password: "GreenScience@2026",
      badge: "Grade 1-A & 2-B",
    },
    {
      label: "Ms. Karen White (English)",
      email: "karen.white@school.com",
      password: "WhiteEnglish@2026",
      badge: "Grade 2-B & 3-B",
    },
  ],
  Registrar: [
                    ...
                    {hints.length > 0 && (
                      <div className="pt-2">
                        ...
                        >
                          ...
                          <ChevronDown
                            className={`w-4 h-4 transition-transform duration-300 ${showHints ? "rotate-180" : ""}`}
                          />
                        </button>
                  ...
                  <div className="flex flex-col items-center text-center py-4 space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-brand-text font-semibold text-sm max-w-sm mx-auto leading-relaxed">
                        To protect administrative records and student data,{" "}
                        {activeRole.toLowerCase()} authentication is handled via
